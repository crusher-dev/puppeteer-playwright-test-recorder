...
function DesktopBrowser(props: any) {
  ...
  const deviceInfoIndex = devices.findIndex((device) => device.id === selectedDeviceId);
  ...
  function Addressbar() {
    ...
    return (
            <div style={styles.addressBar}>
                <div
                    style={{
                      width: '1.75rem', display: 'flex', justifyContent: 'center', alignItems: 'center',
                    }}>
...
function App() {
  ...
  messageListenerCallback = function (event: any) {
    const {
      type, eventType, value, selectors,
    } = event.data;
