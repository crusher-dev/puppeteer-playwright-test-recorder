...
export function SEOModelContent({ handleClick }) {
    return (
...
function BottomBar() {
  return (
    <div style={styles.bottomBar}>
      ...
      <div id={"modal-button"} style={styles.button}>
        Save Test
      </div>
    </div>
  );
  ...
  return (
    <div id="top-bar" style={styles.topBar}>
      <div id="left-section" style={styles.topLeftSection}>
        ...
        <div className="heading_cotainer">
...
function BrowserIcons({props}: { props: any }) {
  return (
...
function BulbIcon({props}: { props: any }) {
  return (
